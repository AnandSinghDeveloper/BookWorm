...
const SignUpView = () => {
  ...
  return (
    <div className="shadow-input border  border-orange-200 mx-auto w-full max-w-md rounded-xl bg-white p-5 md:rounded-2xl md:p-8 dark:bg-black">
      <h2 className="md:text-2xl text-center  mb-3 flex gap-2 font-heading font-bold text-neutral-800 dark:text-neutral-200">
        Welcome to Bookworm
      ...
      <form className="my-1" onSubmit={handleSubmit}>
        <div className="mb-2 flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-2">
          <LabelInputContainer>
            ...
            <Input id="firstname" placeholder="Anand" type="text" />
          </LabelInputContainer>
          <LabelInputContainer>
        ...
        <div className="text-sm text-neutral-700 dark:text-neutral-300 px-4 mt-4">
          {" "}
